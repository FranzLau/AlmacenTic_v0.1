<?php
	...
	if ($emple === 1 ) {
		...
		if ($emplea === 1) {
			...
			$reg = $con->query("INSERT INTO empleado (nom_empleado,ape_empleado,cargo_empleado,area_empleado,gerencia_empleado,email_empleado,telefono_empleado,estado_empleado) VALUES ('$nomEmpReg','$apeEmpReg','$carEmpReg','$areaEmpReg','$grEmpReg','$correoEmpReg','$telEmpReg','$estEmpReg')");
			if ($reg) {
