<?php
	...
	if ($emple === 1 ) {
		...
		if ($emplea === 1) {
			...
			$reg = $con->query("INSERT INTO empleado (nom_empleado,ape_empleado,cargo_empleado,gerencia_empleado,grupo_empleado,estado_empleado) VALUES ('$nomEmpReg','$apeEmpReg','$carEmpReg','$grEmpReg','$gpoEmpReg','$estEmpReg')");
			if ($reg) {
